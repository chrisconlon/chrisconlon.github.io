...
\item Discrete Prices and the Incidence and Efficiency of Excise Taxes   \\\textit{American Economic Journal: Economic Policy} (November 2020). (with Nirupama Rao) 
...
\item All Units Discount: Experimental Evidence from the Vending Industry (w/ J. Mortimer). \\\textit{Journal of Political Economy} (Conditionally Accepted).
